...
async function fetchAPI(query, { variables } = {}) {
	...
	console.log(typeof API_URL, 'type of API_URL');
	console.log(
		typeof res,
		'type of response, should be NowResponse and NextApiResponse'
	);
	const json = await res.json();
	console.log(typeof (json, 'type of json returned on res'));
	if (json.errors) {
...
export async function getAllPostsWithSlug() {
  ...
  `);
	console.log(typeof date, 'this is the type of data expected');
	return data?.posts;
}
...
export async function getAllPostsForCategory(desiredCategory) {
	...
	const categoryObj = data.categories.edges.filter((category, index) => {
		category.node.name === desiredCategory;
	});

	console.log(categoryObj);

	return categoryObj.node.posts;
}
