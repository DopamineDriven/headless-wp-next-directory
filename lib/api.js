...
export async function getPlugins() {
	...
	console.log(`plugin name ${data.plugins.edges.node.name}`);
	console.log(`plugin author ${data.plugins.edges.node.author}`);
	console.log(`plugin id ${data.plugins.edges.node.id}`);
