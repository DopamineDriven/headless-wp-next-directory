...
export interface CardsCoalesced_posts_edges_node_categories_edges_node {
	__typename: 'Category';
	/**
...
export interface CardsCoalesced_posts_edges_node_categories_edges {
	__typename: 'PostToCategoryConnectionEdge';
	/**
	 * The item at the end of the edge
	 */
	node: CardsCoalesced_posts_edges_node_categories_edges_node | null;
}

export interface CardsCoalesced_posts_edges_node_categories {
	__typename: 'PostToCategoryConnection';
	/**
	 * Edges for the PostToCategoryConnection connection
	 */
	edges: (CardsCoalesced_posts_edges_node_categories_edges | null)[] | null;
}
...
export interface CardsCoalesced_posts_edges_node {
	 ...
	 */
	categories: CardsCoalesced_posts_edges_node_categories | null;
}
