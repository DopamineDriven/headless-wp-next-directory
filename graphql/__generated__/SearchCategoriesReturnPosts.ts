...
export interface SearchCategoriesReturnPosts_categories_edges_node_posts_edges_node_categories_edges_node {
	__typename: 'Category';
	/**
...
export interface SearchCategoriesReturnPosts_categories_edges_node_posts_edges_node_categories_edges {
	__typename: 'PostToCategoryConnectionEdge';
	/**
	 * The item at the end of the edge
	 */
	node: SearchCategoriesReturnPosts_categories_edges_node_posts_edges_node_categories_edges_node | null;
}

export interface SearchCategoriesReturnPosts_categories_edges_node_posts_edges_node_categories {
	__typename: 'PostToCategoryConnection';
	/**
	 * Edges for the PostToCategoryConnection connection
	 */
	edges:
		| (SearchCategoriesReturnPosts_categories_edges_node_posts_edges_node_categories_edges | null)[]
		| null;
}
...
export interface SearchCategoriesReturnPosts_categories_edges_node_posts_edges_node {
	 ...
	 */
	categories: SearchCategoriesReturnPosts_categories_edges_node_posts_edges_node_categories | null;
}
