...
export default function MoreCards({ posts }: CardsProps) {
	return (
		<section>
			...
			<div className='grid grid-cols-1 text-center align-middle sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-x-portfolio gap-y-portfolio md:max-w-imagePortfolioMobile max-w-imagePortfolioMobile'>
